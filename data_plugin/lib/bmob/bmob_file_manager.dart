...
class BmobFileManager {
  ...
  static Future<BmobFile> upload(File file) async {
    ...
    //获取所上传文件的二进制流
    Map<String, dynamic> responseData = await BmobDio.getInstance().upload(path, data: file.readAsBytes());
  ...
  static Future<BmobHandled> delete(String url) async {
    ...
    Map<String, dynamic> responseData = await BmobDio.getInstance().delete(path);
